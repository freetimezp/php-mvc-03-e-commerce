                    ...
                    <div class="col-sm-6">
                        <div class="social-icons pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="<?= Settings::instagram_link() ?>"><i class="fa fa-dribbble"></i></a></li>
                                <li><a href="<?= Settings::youtube_link() ?>"><i class="fa fa-google-plus"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                <li>
                                    <a href="<?= ROOT ?>" class="<?= $page_title == 'Home' ? 'active' : ''; ?>">
                                        Home
                                    </a>
                                </li>
                                <li class="dropdown">
                                ...
                                <li class="dropdown">
                                    <a href="<?= ROOT ?>blog" class="<?= $page_title == 'Blog' ? 'active' : ''; ?>">
                                        Blog
                                    </a>
                                </li>
                                <li>
