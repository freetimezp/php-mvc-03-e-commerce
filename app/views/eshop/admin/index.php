    ...
    <section id="container">
                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="<?= ASSETS ?>admin/assets/img/ui-zac.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="<?= ASSETS ?>admin/assets/img/ui-divya.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="<?= ASSETS ?>admin/assets/img/ui-danro.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="<?= ASSETS ?>admin/assets/img/ui-sherman.jpg"></span>
                                    <span class="subject">
        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <p class="centered"><a href="profile.html"><img src="<?= ASSETS ?>admin/assets/img/ui-sam.jpg" class="img-circle" width="60"></a></p>
                        ...
                        <div class="row mt">
                            ...
                            <div class="col-md-4 col-sm-4 mb">
                                <div class="white-panel pn">
                                    ...
                                    <div class="centered">
                                        <img src="<?= ASSETS ?>admin/assets/img/product.png" width="120">
                                    </div>
                                </div>
                            </div><!-- /col-md-4 -->
      ...
      *********************************************************************************************************************************************************** -->
                    ...
                    <div class="col-lg-3 ds">
                        ...
                        <div class="desc">
                            <div class="thumb">
                                <img class="img-circle" src="<?= ASSETS ?>admin/assets/img/ui-divya.jpg"
                        ...
                        <div class="desc">
                            <div class="thumb">
                                <img class="img-circle" src="<?= ASSETS ?>admin/assets/img/ui-sherman.jpg" width="35px" height="35px">
                            </div>
                            <div class="details">
                        ...
                        <div class="desc">
                            <div class="thumb">
                                <img class="img-circle" src="<?= ASSETS ?>admin/assets/img/ui-danro.jpg" width="35px" height="35px">
                            </div>
                            <div class="details">
                        ...
                        <div class="desc">
                            <div class="thumb">
                                <img class="img-circle" src="<?= ASSETS ?>admin/assets/img/ui-zac.jpg" width="35px"
                                    height="35px">
                            </div>
                            <div class="details">
                        ...
                        <div class="desc">
                            <div class="thumb">
                                <img class="img-circle" src="<?= ASSETS ?>admin/assets/img/ui-sam.jpg"
                                    width="35px" height="35px">
                            </div>
                            <div class="details">
